      ...
      <div className="h-screen ">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-10 max-w-3xl mx-auto">
          ...
          <div className="flex justify-center items-center rounded-lg shadow-lg hover:scale-110 cursor-pointer duration-500 py-4 text-center">
            ...
            <h2 className="font-normal ml-10 my-auto">HTML</h2>
          </div>
          {/* CSS */}
          <div className="flex justify-center items-center rounded-lg shadow-lg hover:scale-110 cursor-pointer duration-500 py-4 text-center">
            <div className="py-auto">
            ...
            <h2 className="font-normal ml-10 my-auto">CSS</h2>
          </div>
          {/* Javascript */}
          <div className="flex justify-center items-center rounded-lg shadow-lg hover:scale-110 cursor-pointer duration-500 py-4 text-center">
            <div className="py-auto">
            ...
            <h2 className="font-normal ml-10 my-auto">Javascript</h2>
          </div>
          {/* React */}
          <div className="flex justify-center items-center rounded-lg shadow-lg hover:scale-110 cursor-pointer duration-500 py-4 text-center">
            <div className="py-auto">
            ...
            <h2 className="font-normal ml-10 my-auto">REACT</h2>
          </div>
          {/* Tailwind */}
          <div className="flex justify-center items-center rounded-lg shadow-lg hover:scale-110 cursor-pointer duration-500 py-4 text-center">
            <div className="py-auto">
            ...
            <h2 className="font-normal ml-10 my-auto">Tailwind</h2>
          </div>
          {/* Next */}
          <div className="flex justify-center items-center rounded-lg shadow-lg hover:scale-110 cursor-pointer duration-500 py-4 text-center">
            <div className="py-auto">
            ...
            <h2 className="font-normal ml-10 my-auto">Next</h2>
          </div>
          {/* Node */}
          <div className="flex justify-center items-center rounded-lg shadow-lg hover:scale-110 cursor-pointer duration-500 py-4 text-center">
            <div className="py-auto">
            ...
            <h2 className="font-normal ml-10 my-auto">NODE</h2>
          </div>
          {/* Firebase */}
          <div className="flex justify-center items-center rounded-lg shadow-lg hover:scale-110 cursor-pointer duration-500 py-4 text-center">
            <div className="py-auto">
            ...
            <h2 className="font-normal ml-10 my-auto">Firebase</h2>
          </div>
          {/* SQL */}
          <div className="flex justify-center items-center rounded-lg shadow-lg hover:scale-110 cursor-pointer duration-500 py-4 text-center">
            <div className="py-auto">
            ...
            <h2 className="font-normal ml-10 my-auto">SQL</h2>
          </div>
        </div>
      </div>
    </>
